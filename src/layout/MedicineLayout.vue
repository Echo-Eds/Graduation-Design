...
import DetialsAside from "../components/Detials/medicineAside.vue";
import SysBottom from "../components/sys/SysBottom.vue";
import ProfessorSearch from "../components/Detials/medicineSearch.vue";
export default {
  name: "",
  components: {
    SysHeader,
